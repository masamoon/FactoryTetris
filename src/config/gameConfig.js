...
export const GAME_CONFIG = {
  ...
  roundBaseMoney: 65,
  roundMoneyGrowth: 14,
  roundCashPayoutMultiplier: 0.4,
  paidBeltFreeClearBonusBase: 0,
  paidBeltFreeClearBonusGrowth: 0,
  paidBeltFreeClearBonusCap: 0,
  untimedBuildRounds: true,
  emergencyRewiresPerRound: 1,
