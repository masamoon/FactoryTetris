...
- **Extractors**: Collect resources from resource nodes.
- **Processors**: Convert raw resources into products.
- **Conveyors**: Transport resources between machines.
...
Resource nodes appear randomly on the factory grid and have a limited lifespan. Place extractors near them to collect resources before they disappear.
